export const movies = [
  ...
  },
  {
    ...
    description: "A mother struggles to make a better life for her daughter.",
  ...
  },
  {
    ...
    director: "Mateo Gil",
    description:
      "Marc (Tom Hughes) is diagnosed with a disease and is given one year left to live. Unable to accept his own end, he decides to freeze his body. Sixty years later, in the year 2084, he ... See full summary »",
  ...
  },
  {
    ...
    description:
      "Anne is at a crossroads in her life. Long married to a successful, driven but inattentive movie producer, she unexpectedly finds herself taking a car trip from Cannes to Paris with a ... See full summary »",
  ...
  },
  {
    ...
    description: "The lives of four black students at an Ivy League college.",
    actors: [
  ...
  },
  {
    ...
    genre: ["Biography", "Comedy", "Drama"],
    director: "Glenn Ficarra",
    description: "A journalist recounts her wartime coverage in Afghanistan.",
  ...
  },
  {
    ...
    description: "A kick boxer is out to avenge his brother.",
    actors: [
      "Dave Bautista",
      "Alain Moussi",
      "Gina Carano",
  ...
  },
  {
    ...
    description: "Two teenage girls encounter an Internet child predator.",
    actors: [
      "Amber Perkins",
      "Rachel Quinn",
      "Dean Waite",
  ...
  },
  {
    ...
    actors: ["Edward Norton", "Jessica Biel", "Paul Giamatti", "Rufus Sewell"],
  },
  {
    year: "2010",
    votes: "219116",
  ...
  },
  {
    ...
    genre: ["Drama"],
    director: "Jamal Hill",
    description: "An agent infiltrates a crime ring ran by a charismatic boss.",
